...
class TestParseHeader : public RvmParser::Parser::Composite::ParseHeader<RvmParser::Default::Rvm::DefaultHeader, std::string, RvmParser::Parser::Basic::ParseInteger, 4>
{
private:
...
public:
	...
	RvmParser::Parser::Composite::ParseHeader<RvmParser::Default::Rvm::DefaultHeader, std::string, RvmParser::Parser::Basic::ParseInteger, 4>(reinterpret_cast<const unsigned char*>(testData1), integerParser),
	m_success(true)
	{
		try {
			RvmParser::Default::Rvm::DefaultHeader testHeader1("HEAD"s, 2, 200);
			RvmParser::Default::Rvm::DefaultHeader testHeader2("MODL"s, 1, 244);
